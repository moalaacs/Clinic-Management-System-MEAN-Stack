...
export declare class CarouselComponent implements OnInit, OnDestroy, AfterContentInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<CarouselComponent, "c-carousel", never, { "activeIndex": "activeIndex"; "animate": "animate"; "dark": "dark"; "direction": "direction"; "interval": "interval"; "pause": "pause"; "touch": "touch"; "transition": "transition"; "wrap": "wrap"; }, { "itemChange": "itemChange"; }, never, ["*"], false, never>;
}
